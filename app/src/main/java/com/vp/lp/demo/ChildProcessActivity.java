...
public class ChildProcessActivity extends Activity implements View.OnClickListener{
    private static final String TAG = "ChildProcessActivity";

    private SPMultiProcessImpl mSPMultiProcessImpl =null;
    private Button mCommit,mQuery,mRemove,mCommitSetString,mQuerySetString,mQueryAll,mClearAll;
